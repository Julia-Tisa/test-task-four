				...
				<div className="container">
					<Row align="middle">
						<Col xs={24} sm={24} md={8}>
							<h1 className="font-weight-bold mb-4 display-4">Страница не найдена</h1>
							<p className="font-size-md mb-4">Мы заметили, что вы заблудились, не волнуйтесь, мы поможем вам найти правильный путь.</p>
							<Link to='/app'>
								<Button type="primary" icon={<ArrowLeftOutlined />}>Вернуться</Button>
							</Link>
						</Col>
